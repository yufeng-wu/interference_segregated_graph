...
def df_for_estimation(network, ind_set, sample):
    ...
    for i in ind_set['subject']:
        ...
        N_i = network_utils.kth_order_neighborhood(network, i, 1)
...
def run_experiment(num_subjects):
    ...
    if USE_EXISTING_DATA:
        ...
        network = network_utils.create_random_network(n=NUM_OF_SUBJECTS, min_neighbors=1, max_neighbors=6)
...
def run_experiments_with_multiprocessing():
    ...
    output_file = '../result/autog_experiments/AUTOG_FIXED_L.csv'
